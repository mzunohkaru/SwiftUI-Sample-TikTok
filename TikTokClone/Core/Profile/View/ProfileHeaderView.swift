...
//                 UserStatView(value: user.stats.followers, title: "Followers")
                ...
                NavigationLink(destination: UserListView(config: UserListConfig.following(user.id))) {
                    UserStatView(value: user.stats.following, title: "Following")
                }
                .disabled(user.stats.following == 0)
                
                NavigationLink(destination: UserListView(config: UserListConfig.followers(user.id))) {
                    UserStatView(value: user.stats.followers, title: "Followers")
                }
